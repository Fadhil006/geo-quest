...
class MapGridConfig {
  ...
  // Centered around (22.5726, 88.3639) with ~600 m extent
  static const double minLat = 22.5690; // bottom edge
  static const double maxLat = 22.5762; // top edge
  static const double minLng = 88.3599; // left edge
  static const double maxLng = 88.3679; // right edge
