...
final List<Map<String, dynamic>> sampleChallenges = [
  ...
  // ══════════════════════════════════════
  {
    ...
    'difficulty': 'easy',
    'type': 'multipleChoice',
    'location': {'latitude': 22.5726, 'longitude': 88.3639}, // Replace with campus coords
    'geofenceRadius': 20,
    'points': 10,
  ...
  },
  {
    ...
    'difficulty': 'easy',
    'type': 'textInput',
    'location': {'latitude': 22.5720, 'longitude': 88.3635},
    'geofenceRadius': 20,
    'points': 10,
  ...
  // ══════════════════════════════════════
  {
    ...
    'difficulty': 'medium',
    'type': 'textInput',
    'location': {'latitude': 22.5735, 'longitude': 88.3650},
    'geofenceRadius': 20,
    'points': 25,
    'timeLimitSeconds': 180,
  ...
  },
  {
    ...
    'difficulty': 'medium',
    'type': 'multipleChoice',
    'location': {'latitude': 22.5740, 'longitude': 88.3642},
    'geofenceRadius': 20,
    'points': 25,
    'timeLimitSeconds': 180,
  ...
  },
  {
    ...
    'difficulty': 'medium',
    'type': 'textInput',
    'location': {'latitude': 22.5728, 'longitude': 88.3648},
    'geofenceRadius': 20,
    'points': 30,
    'timeLimitSeconds': 180,
  ...
  },
  {
    ...
    'difficulty': 'hard',
    'type': 'textInput',
    'location': {'latitude': 22.5715, 'longitude': 88.3630},
    'geofenceRadius': 20,
    'points': 50,
    'timeLimitSeconds': 180,
  ...
  // ══════════════════════════════════════
  {
    ...
    'difficulty': 'expert',
    'type': 'textInput',
    'location': {'latitude': 22.5750, 'longitude': 88.3660},
    'geofenceRadius': 25,
    'points': 100,
  ...
  },
  {
    ...
    'difficulty': 'expert',
    'type': 'multipleChoice',
    'location': {'latitude': 22.5710, 'longitude': 88.3625},
    'geofenceRadius': 25,
    'points': 100,
    'timeLimitSeconds': 300,
